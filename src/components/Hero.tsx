...
import heroImage1 from '@/images/hero-section/hero1.jpg'
import heroImage2 from '@/images/hero-section/hero2.jpg'
import heroImage3 from '@/images/hero-section/hero3.jpg'
import heroImage4 from '@/images/hero-section/hero4.jpeg'
import heroImage5 from '@/images/hero-section/hero5.jpeg'
import heroImage6 from '@/images/hero-section/hero6.jpeg'
          ...
          <div className="mx-auto max-w-7xl px-6 pb-32 pt-12 sm:pt-30 lg:px-8 lg:pt-12">
            <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-top">
              <div className="relative w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                <h1 className="text-4xl font-bold tracking-tight text-gray-900 mt-16 sm:text-6xl">
                Empowering Change Find Your Case
                </h1>
                <p className="mt-6 text-lg leading-8 text-gray-600 sm:max-w-md lg:max-w-none">
                Embark on a journey of meaningful change with our NGO finding website. Explore a diverse array of causes and organizations, tailored to match your passions and skills.
                </p>
