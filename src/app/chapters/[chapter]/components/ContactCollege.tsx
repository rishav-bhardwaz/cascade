export function ContactCollege() {
  return (
          ...
          <div className="lg:mt-6 lg:w-80 lg:flex-none">
            ...
            <figure className="mt-10">
              ...
              <figcaption className="mt-10 flex gap-x-6">
                ...
                />
                <div>
                  <div className="text-base font-semibold text-gray-900">Harsh Singh</div>
                  <div className="text-sm leading-6 text-gray-600">Lead</div>
                </div>
              </figcaption>
            </figure>
          </div>
