...
const steps = [
  {
    ...
    description:
      'Join us by submitting your mentor application.',
  },
  {
    name: 'Connect with Students',
    description:
      'Get paired with eager and motivated learners.',
  },
  {
    name: 'Offer Support and Guidance',
    description:
      'Empower students with your expertise and mentorship.',
  },
]
        ...
        <div className="mx-auto max-w-2xl sm:text-center">
          <h2 className="font-display text-3xl tracking-tight text-white sm:text-4xl">
            <span className="relative whitespace-nowrap">
              ...
              <span className="relative">Interested</span>
            </span>{' '}
